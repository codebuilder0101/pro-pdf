...
// EXACT block from converted page 3 (VERIZON row), positioned near top of page
const content = `BT
/F1 9 Tf
90.998 700 Td
<3928352C3D3231033A2C35282F283636032728361D33243C30283137360303032C271D131A151A16191517141C13131313140303>Tj
0 -9.475 TD
<2C3127311D13131313131313131A151A16191517141C1313131314032632032C271D141515161617171A1C1703333327>Tj
ET`;
...
fs.writeFileSync('repro.pdf',pdf);
...
fs.writeFileSync(path.resolve('../repro.png'),pix.asPNG());
console.log('done');
EOF
