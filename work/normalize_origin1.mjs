// Normalize origin1.pdf: decompress object streams so regex-based rewriting can see every object.
import fs from 'fs';
import path from 'path';
import * as mupdf from 'mupdf';

const srcPath = path.resolve('../asset/origin1.pdf');
const dstPath = path.resolve('origin1_normalized.pdf');
